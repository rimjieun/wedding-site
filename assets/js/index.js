...
function loadMobileImages() {
  $('#cycler')
    ...
    .append($('<img class="size-ref" src="assets/img/photos/portrait/new/005.jpg" alt="Naeun & Jeremy" />'))
    .append($('<img class="size-ref" src="assets/img/photos/portrait/new/006.jpg" alt="Naeun & Jeremy" />'));
}
